...
public class ShareData : BaseSettingsPlugin<ShareDataSettings>
{
    ...
    public List<float> getScreenPos(int grid_x, int grid_y)
    {
        ...
        var height = GameController.EntityListWrapper.Player.PosNum.Z;//r.TerrainHeight
        try
        {
    ...
    public List<Entity_c> getAwakeEntities(){
        ...
        foreach (var obj in GameController.EntityListWrapper.Entities)
        {
            ...
            entity.i = (int)obj.Id;
            entity.p = obj.Path;
            entity.gp = new List<int> { (int)obj.GridPosNum.X, (int)obj.GridPosNum.Y };
            entity.wp = new List<int> { (int)obj.BoundsCenterPosNum.X,(int)obj.BoundsCenterPosNum.Y,(int)obj.BoundsCenterPosNum.Z };
    ...
    public List<ItemOnGroundLabel_c> getItemsOnGroundLabelsVisible(){
        ...
        foreach (var label in GameController.IngameState.IngameUi.ItemsOnGroundLabelsVisible){
            ...
            visible_label.gp = new List<int> {
                (int)label.ItemOnGround.GridPosNum.X,
                (int)label.ItemOnGround.GridPosNum.Y
            };
    ...
    public PlayerInfo_c getPlayerInfo(){
        ...
        player_info.gp = new List<int>{
            (int)GameController.EntityListWrapper.Player.GridPosNum.X,
            (int)GameController.EntityListWrapper.Player.GridPosNum.Y
        };
    ...
    public InventoryObjectCustom_c convertItem(Entity orig_item){
        ...
        var map_component = orig_item.GetComponent<ExileCore.PoEMemory.Components.Map>();
