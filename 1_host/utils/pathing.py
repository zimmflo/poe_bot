...
from utils.utils import angleOfLine, createLineIteratorWithValues, pointOnCircleByAngleAndLength
...
class TSP:
  ...
  def generateSortedPointsForBossRush(self, debug=False):
    ...
    for point in points_to_explore:
      path = poe_bot.pather.generatePath((poe_bot.game_data.player.grid_pos.y, poe_bot.game_data.player.grid_pos.x), (point[1], point[0]))
