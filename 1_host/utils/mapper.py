...
class MapWorldsShipyard(MapArea):
  boss_render_names = ['Musky "Two-Eyes" Grenn', 'Susara, Siren of Pondium', 'Lussi "Rotmother" Roth']
...
class MapWorldsFields(MapArea):
  entities_to_ignore_in_bossroom_path_keys = ["Metadata/Monsters/Bandits/BoarBanditSpectator", "Metadata/Monsters/Ralakesh/Greust/GreustArcher", "Metadata/Monsters/Bandits/BoarBanditSpectator"]

class MapWorldsLavaLake(MapArea):
  boss_render_names = ["Kitava, The Destroyer", ]
  ignore_bossroom = True
...
class MapperSettings:
  ...
  beasts_kill_keywords = ["Black Mórrigan", "Vivid Watcher", "Vivid Vulture","Craicic Chimeral", "Wild Hellion Alpha", "Wild Bristle Matron"]
  ...
  def __init__(self, config:dict) -> None:
    ...
    if self.atlas_explorer is True:
      self.keep_consumables.extend(['Orb of Alchemy', 'Orb of Scouring', 'Scroll of Wisdom', 'Vaal Orb', "Orb of Binding", "Orb of Transmutation"])
    print(str(self))
  def __str__(self):
